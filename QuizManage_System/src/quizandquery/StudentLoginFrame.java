...
/**
 * This class is for creating a 'Login' frame for students.
 */
public class StudentLoginFrame extends JFrame {
    ...
    public void initializeComponents() {
        ...
        button1 = new JButton("New Student?"); // creating button object for new students
        ...
        button1.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent ae) {
                SignupFrameStudent sign = new SignupFrameStudent(); // creating new signup frame object for new students
                dispose(); // disposing current frame
            }
        });
        ...
        button2.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent ae) {
                ...
                if (Files.confirmStudent(name, password)) { // validating user login

                    StudentFrame s_frame = new StudentFrame(new Student(tf1.getText(), new String(pf.getPassword()))); // creating new studentFrame passing Student object
