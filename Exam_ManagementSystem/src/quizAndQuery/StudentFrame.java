...
public class StudentFrame extends JFrame {
    ...
    public void initializeComponents() {
        ...
        inform.setFont(f); // setting font for label
        ...
        inform.setForeground(Color.RED); // setting foreground / font color for label
        ...
        abandon.setBounds(770, 400, 100, 30); // setting boundary for JButton
